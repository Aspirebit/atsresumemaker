        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                <p className="text-xs text-gray-600 dark:text-muted-foreground">Total Resumes</p>
                <p className="text-xl font-bold text-gray-900 dark:text-foreground">{resumes.length}</p>
              </div>
              <div>
                <p className="text-xs text-gray-600 dark:text-muted-foreground">This Month</p>
              ...
              <div>
                <p className="text-xs text-gray-600 dark:text-muted-foreground">Templates Used</p>
                <p className="text-xl font-bold text-gray-900 dark:text-foreground">
